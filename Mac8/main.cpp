        ...
        for(int y = 0; y < 32; ++y) {
            for(int x = 0; x < 64; ++x)
            {
                if(mychip.gfx[(y*64) + x] != 0) {
                    glBegin(GL_QUADS);
                        glVertex3f((float)(x*10), (float)(y*10), 0.0f);
                        glVertex3f((float)(x*10), (float)(y*10) + 10, 0.0f);
                        glVertex3f((float)(x*10) + 10, (float)(y*10) + 10, 0.0f);
                        glVertex3f((float)(x*10) + 10, (float)(y*10), 0.0f);
                    glEnd();
                }
            }
        }
